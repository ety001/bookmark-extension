(function() {
  ...
  var Da,
    Ea,
    Fa = { id: 'hitType', name: 't', valueType: 'text', maxLength: void 0, defaultValue: void 0 },
    ...
    La = { id: 'eventValue', name: 'ev', valueType: 'integer', maxLength: void 0, defaultValue: void 0 },
    Ma = {
      zd: Fa,
      ...
      ge: { id: 'userId', name: 'uid', valueType: 'text', maxLength: void 0, defaultValue: void 0 },
      ...
      Sd: { id: 'socialAction', name: 'sa', valueType: 'text', maxLength: 50, defaultValue: void 0 },
      ...
      Yd: { id: 'timingValue', name: 'utt', valueType: 'integer', maxLength: void 0, defaultValue: void 0 },
    ...
    Jb = function(a, b) {
      ...
      if (!nb) {
        ...
        if (!(0 > e.keyCode || void 0 != e.returnValue)) {
          ...
          for (l = 0; !c.X && l < e.length; l++) (c.currentTarget = e[l]), (D = Pb(e[l], f, !1, c)), (d = d && D);
        }
        return d;
      }
...
*/
  ...
  var Kc = { id: 'apiVersion', name: 'v', valueType: 'text', maxLength: void 0, defaultValue: void 0 },
    ...
    Pc = { id: 'libVersion', name: '_v', valueType: 'text', maxLength: void 0, defaultValue: void 0 },
    Qc = { id: 'sampleRateOverride', name: 'usro', valueType: 'integer', maxLength: void 0, defaultValue: void 0 },
    ...
    Vc = { ad: Kc, dd: Lc, ed: Mc, nd: Nc, Fd: Oc, Gd: Pc, Md: Qc, Nd: Rc, Od: Sc, ae: Tc, he: Uc },
    Xc = function(a) {
      if (!p(a)) return a;
      var b = Wc(a, Ma);
      if (r(b)) return b;
  ...
  h.Uc = function() {
    if (this.enabled) {
      ...
      0 < a && a < 0.8 * this.wa
        ...
        : (this.h && (this.Y.clearTimeout(this.h), (this.h = null)), this.dispatchEvent('tick'), this.enabled && ((this.h = this.Y.setTimeout(this.Pa, this.wa)), (this.ab = u())));
    }
  };
  h.start = function() {
    this.enabled = !0;
  ...
  var wd = function() {
    ...
    pb &&
      (qb
        ...
        : ((this.Eb = pb ? navigator.onLine : !0), (this.h = new sd(250)), this.oa.listen(this.h, 'tick', this.oc), this.h.start()));
  };
  w(wd, M);
  ...
  var Fc = { status: 'device-offline', la: void 0 },
    Bd = { status: 'rate-limited', la: void 0 },
  ...
  X.prototype.send = function(a, b, c, d) {
    ...
    try {
      Vd(this),
        0 < this.Ha && ((this.kb = Wd(this.a)) ? ((this.a.timeout = this.Ha), (this.a.ontimeout = t(this.Mb, this))) : (this.Ga = td(this.Mb, this.Ha, this))),
        (this.va = !0),
        this.a.send(a),
        (this.va = !1);
    } catch (g) {
  ...
  ee.prototype.send = function(a, b) {
    ...
    var c = new Q(),
      d = fe(a, b);
    d.length > this.Aa
      ? c.A({ status: 'payload-too-big', la: Ua('Encoded hit length == %s, but should be <= %s.', d.length, this.Aa) })
      : Ud(
          this.Mc,
          function() {
            c.v(Dd);
...
var GetUid = {
  get: function() {
    if (window.localStorage.uid) {
      ...
      var cpa_obj = new Cpa();
      cpa_obj.sendEvent('create_user', uid);
    }
    return uid;
  },
};
